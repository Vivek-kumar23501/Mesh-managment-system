...
const MessManagerDashboard = () => {
  ...
  useEffect(() => {
    // Fetch the necessary data for Mess Manager
  ...
  const handleApproveReject = async (formId, action) => {
    try {
      await axios.put(`/api/forms/${formId}`, { approvalStatus: action });
  ...
  return (
    <div style={styles.container}>
      ...
      <aside style={styles.sidebar}>
        <div>
          <h2 style={styles.sidebarHeader}>Mess Manager Dashboard</h2>
          <ul style={styles.sidebarList}>
            {['Mess Reduction Approvals', 'Mess Usage Tracking', 'Deductions Summary', 'Student Requests', 'Reports', 'Settings'].map((label, idx) => {
      ...
      <main style={styles.mainContent}>
        ...
        <div style={styles.topbar}>
          ...
          <div style={styles.profileSection}>
            ...
            <div>
              <p><strong>Mess Manager</strong></p>
